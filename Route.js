class Route {
    ...
    show() {
        ...
        for (let i = 0; i < this.waypoints.length - 1; i++) {
            ...
            // Add safety check for waypoints length
            let maxIndex = Math.max(0, this.waypoints.length - 1);
            let hue = p5.prototype.map(i, 0, maxIndex, 0, 155);
        ...
        // Add safety check for bestroute and waypoints
        if (typeof bestroute !== 'undefined' && bestroute && bestroute.waypoints && bestroute.waypoints.length > 0) {
